    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(verbose_name='Category', to='pybb.Category')),
                ('moderators', models.ManyToManyField(to=settings.AUTH_USER_MODEL, null=True, verbose_name='Moderators', blank=True)),
                ('parent', models.ForeignKey(verbose_name='Parent forum', blank=True, to='pybb.Forum', null=True)),
            ],
            options={
                'ordering': ['position'],
                'verbose_name': 'Forum',
        ...
        migrations.AddField(
            model_name='forum',
            name='readed_by',
            field=models.ManyToManyField(to=settings.AUTH_USER_MODEL, through='pybb.ForumReadTracker'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='forumreadtracker',
            name='forum',
            field=models.ForeignKey(blank=True, to='pybb.Forum', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='forumreadtracker',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poll_answer', models.ForeignKey(verbose_name='Poll answer', to='pybb.PollAnswer')),
        ...
        migrations.AddField(
            ...
            name='post',
            field=models.ForeignKey(verbose_name='Post', to='pybb.Post'),
            preserve_default=True,
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('user', annoying.fields.AutoOneToOneField(verbose_name='User', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forum', models.ForeignKey(verbose_name='Forum', to='pybb.Forum')),
                ('subscribers', models.ManyToManyField(to=settings.AUTH_USER_MODEL, verbose_name='Subscribers', blank=True)),
                ('user', models.ForeignKey(verbose_name='User', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created'],
        ...
        migrations.AddField(
            model_name='topic',
            name='readed_by',
            field=models.ManyToManyField(to=settings.AUTH_USER_MODEL, through='pybb.TopicReadTracker'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='topicreadtracker',
            name='topic',
            field=models.ForeignKey(blank=True, to='pybb.Topic', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='topicreadtracker',
